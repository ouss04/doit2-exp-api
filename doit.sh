...
--    ON Clientes.id = Ventas.clienteId;
    ...
    SELECT Clientes.id as "CLI", Ventas.id as "VENT", Ventas.clienteID FROM 
    Clientes JOIN Ventas 
    ON Clientes.id = Ventas.clienteId;

    SELECT Vehiculo.id as "vehiculo", Ventas.id as "VENT", Ventas.vehiculoID FROM 
    Vehiculo JOIN Ventas 
    ON Vehiculo.id = Ventas.vehiculoId;
"
